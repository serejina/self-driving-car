...
def project_detections_into_bev(bev_map, detections, configs, color=[]):
    for row in detections:
        ...
        print("corners_int: ", corners_int[0, 0], corners_int[0, 1], corners_int[3, 0], corners_int[3, 1])
        print("types: ", type(corners_int[0, 0]), type(corners_int[0, 1]), type(corners_int[3, 0]), type(corners_int[3, 1]))
